...
#
# Цель задания: Освоить создание функций с параметрами
# по умолчанию и практику вызова этих функций с различным количеством аргументов.
#
# Задача "Распаковка":
...
values_list = ['Гамак', 55, [1, 2, 3]]
values_dict = {'a': [1, 2, 3], 'b': 'Гамак', 'c': 55}
print_params(*values_list)
print_params(**values_dict)
# Распаковка + отдельные параметры:
values_list_2 = ['Строка', [4, 5, 6]]
print_params(*values_list_2, 42)