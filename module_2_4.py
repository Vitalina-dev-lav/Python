...
# 5      В процессе проверки на простоту записывайте числа
# из списка numbers в списки primes и not_primes в зависимости от значения переменной
# is_prime после проверки (True - в prime, False - в not_prime).
...
# Попробуйте оптимизировать(ускорить)
